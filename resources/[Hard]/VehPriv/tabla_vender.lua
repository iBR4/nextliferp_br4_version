local Markervender = {
{Posiciones={1371.9547119141, -1892.4736328125, 13}, textoMarker="#ffffffPuesto de venta de vehículos", int = 0, dim = 0},
{Posiciones={2572.6618652344, -1126.2003173828, 65}, textoMarker="#ffffffPuesto de venta de vehículos", int = 0, dim = 0},
