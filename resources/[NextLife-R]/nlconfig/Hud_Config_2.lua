...
addEventHandler("onClientRender", root,
    function()
        ...
        -- print(getElementData(localPlayer,"Agua"),getElementData(localPlayer,"Comida"))
        -- print(roundValue(getElementData(localPlayer,"Roleplay:stamina")))
       
        -- if getElementData(localPlayer,"Roleplay:stamina") ~= false then
        ...
        local Total_Comida = (100)*(getElementData(localPlayer,"Comida")/100)
        local Total_Agua = (100)*(getElementData(localPlayer,"Agua")/100)
        ...
        dxDrawText(math.floor(getElementData(localPlayer,"Comida")).."%", (1850 - 1)*sx, (55 - 1)*sy, (1844 - 1)*sx, (93 - 1)*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Comida")).."%", (1850 + 1)*sx, (55 - 1)*sy, (1844 + 1)*sx, (93 - 1)*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Comida")).."%", (1850 - 1)*sx, (55 + 1)*sy, (1844 - 1)*sx, (93 + 1)*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Comida")).."%", (1850 + 1)*sx, (55 + 1)*sy, (1844 + 1)*sx, (93 + 1)*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Comida")).."%", 1850*sx, 55*sy, 1844*sx, 93*sy, tocolor(196, 189, 13, 254), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Agua")).."%", (1850 - 1)*sx,( 94 - 1 )*sy, (1844 - 1)*sx, ( 132 - 1 )*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Agua")).."%", (1850 + 1)*sx,( 94 - 1 )*sy, (1844 + 1)*sx, ( 132 - 1 )*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Agua")).."%", (1850 - 1)*sx,( 94 + 1 )*sy, (1844 - 1)*sx, ( 132 + 1 )*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Agua")).."%", (1850 + 1)*sx,( 94 + 1 )*sy, (1844 + 1)*sx, ( 132 + 1 )*sy, tocolor(0, 0, 0, 255), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        dxDrawText(math.floor(getElementData(localPlayer,"Agua")).."%", 1850*sx, 94*sy, 1844*sx, 132*sy, tocolor(252, 74, 115, 254), 1.00*sy, "pricedown", "right", "center", false, false, false, false, false)
        ...
        if chalecoBarra > 0 then
            ...
            dxDrawRectangle(1480*sx, 168*sy, 174*sx, 8*sy, tocolor(255,69,0, 93), false)
            dxDrawRectangle(1480*sx, 168*sy, sprintBarra*sx, 8*sy, tocolor(255,69,0, 223), false)
            --
        else
            -- Sprint
            dxDrawRectangle(1474*sx, 146*sy, 184*sx, 16*sy, tocolor(3, 0, 0, 207), false)
            dxDrawRectangle(1480*sx, 150*sy, 174*sx, 8*sy, tocolor(255,69,0, 93), false)
            dxDrawRectangle(1480*sx, 150*sy, sprintBarra*sx, 8*sy, tocolor(255,69,0, 223), false)
        end
